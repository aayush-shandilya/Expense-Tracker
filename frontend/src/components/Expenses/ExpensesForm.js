...
function ExpenseForm() {
  ...
  //   if (!inputState.amount || parseFloat(inputState.amount) <= 0) {
  //     setError('Please enter a valid positive amount');
  //     return;
  //   }
  ...
  //     formData.append('title', inputState.title.trim());
  //     formData.append('amount', parseFloat(inputState.amount));
  //     formData.append('description', inputState.description.trim());
  ...
  //     // Add categories as a JSON string to ensure proper array handling
